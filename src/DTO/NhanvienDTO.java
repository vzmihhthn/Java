...
public class NhanvienDTO {
    ...
    public NhanvienDTO(String MaNv, String TenNv, String Gioitinh, Date Ngaysinh, String Diachi, String Email, String Sodienthoai, Date Ngayvaolam, String SoCMND, String MaPB, String TenPbnv, String MaCv, String TenCvnv, String MaDA, String Tendanv) {
        this.MaNv = MaNv;
        this.TenNv = TenNv;
    ...
    public NhanvienDTO(String MaNv, String TenNv, String Gioitinh, Date Ngaysinh, 
            ...
            String SoCMND, String TenPbnv, String TenCvnv, String Tendanv) {
        this.MaNv = MaNv;
        this.TenNv = TenNv;
        this.Gioitinh = Gioitinh;
        this.Ngaysinh = Ngaysinh;
