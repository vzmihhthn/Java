...
public class BCTKhenKiLuat extends javax.swing.JPanel {
 ...
 CTKhenKiluatBUS ctkhenkiluatbus;
                ...
                public void mouseClicked(MouseEvent e) 
        {
                int row = tablectkl.getSelectedRow();
                    if (row >= 0) {
                        ...
                        Object objMaKTKL = tablectkl.getValueAt(row, 0);
                        if (objMaKTKL != null) {
                            MaKTKL = objMaKTKL.toString();
                        }

                        Object objMaNv = tablectkl.getValueAt(row, 1);
                        if (objMaNv != null) {
                            MaNv = objMaNv.toString();
                        }

                        Object objTenNv = tablectkl.getValueAt(row, 2);
                        if (objTenNv != null) {
                            TenNv = objTenNv.toString();
                        }

                        Object objSotien = tablectkl.getValueAt(row, 3);
                        if (objSotien != null) {
                            Sotien = Float.parseFloat(objSotien.toString());
                        }

                        Object objNgayquyetdinh = tablectkl.getValueAt(row, 4);
                        ...
                        Object objHinhthuc = tablectkl.getValueAt(row, 5);
                        if (objHinhthuc != null) {
                            hinhthuc = objHinhthuc.toString();
                        }

                        Object objNoidung = tablectkl.getValueAt(row, 6);
                        if (objNoidung != null) {
    ...
    private void initComponents() {
        ...
        noidungf.setBackground(new java.awt.Color(255, 255, 255));
        noidungf.setColumns(20);
        noidungf.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        noidungf.setRows(5);
        jScrollPane1.setViewportView(noidungf);
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel7Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(tennvf, javax.swing.GroupLayout.DEFAULT_SIZE, 184, Short.MAX_VALUE)
                            .addComponent(manvf)))
                    .addGroup(jPanel7Layout.createSequentialGroup()
                        .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel7Layout.createSequentialGroup()
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jPanel7, javax.swing.GroupLayout.PREFERRED_SIZE, 1335, Short.MAX_VALUE)
                .addContainerGap())
        );
