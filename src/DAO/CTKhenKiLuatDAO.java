...

{
    ...
    ResultSet rs= null;
        ...
        public static void main(String[] args) {
            ...
            {
                System.out.println(ctkl.getMaKTKL()+ "  "+ctkl.getMaNv()+"  "+ctkl.getTennvct()+"  "+ctkl.getSotien()+"  "+
        ...
        public  ArrayList<CTKhenKiLuatDTO> getCTKhenKiLuat()
        {
            try {
                ...
                stmt = conn.prepareStatement("select kl.MaKTKL, nv.MaNv,nv.TenNv, ctkl.SoTien,ctkl.NgayQuyetDinh,ctkl.HinhThuc,ctkl.NoiDung\n" +
